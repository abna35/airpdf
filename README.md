...
airpdf is a web application designed for chatting with your PDF documents. It's built using Laravel, Livewire, and a bit of React.
...
1. Clone the repository:
   ```
   git clone https://github.com/abinantonyarackapparampil/airpdf.git
   cd airpdf
   ```
...
1. Report [issues](https://github.com/abinantonyarackapparampil/airpdf/issues) if you encounter errors or bugs.
1. Submit [pull requests](https://github.com/abinantonyarackapparampil/airpdf/pulls) for bug fixes, adding new features, or improving documentation.
