        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="mt-[70px] max-w-5xl mx-auto pb-8 text-center">
                    ...
                    <div class="max-w-2xl mx-auto">
                        <h2 class="mt-6 leading-snug text-neutral-500 xl:mt-5 xl:text-xl dark:text-neutral-400">
                            {{__('With airpdf, your PDFs become a source of interactive learning. Ask questions, gain insights, and discover what you didn\'t know.')}}
                        </h2>
                    </div>
                ...
                <div class="mx-auto max-w-7xl rounded-3xl shadow-2xl overflow-hidden p-2 bg-neutral-700 dark:bg-neutral-800">
                    <img src="https://www.peakadventuretour.com/assets/imgs/kerala-tourism-04.webp" class="rounded-2xl" />
                </div>
            </div>
        </div>
    </div>
